...
9. T7 依赖 T5：执行当前 14 站 Access Preflight，确定 Wave 1 Batch 1 是否可以生成站点 tickets。
...
- 每张票继承 Reference Baseline `c1ad69676f220b5ef382bbf4c387a2486daf8355`；Execution Baseline 由 T0 填入后，其他票才能进入 `ready-for-agent`。
