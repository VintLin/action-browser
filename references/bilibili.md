...
```bash
python3 scripts/bilibili_workflow.py hot view --count 10

python3 scripts/bilibili_workflow.py ranking view --count 20

python3 scripts/bilibili_workflow.py search view \
  --query "OpenAI" \
  --type video \
  --count 10
...
python3 scripts/bilibili_workflow.py video view \
  --url "BV1xx411c7mD"

python3 scripts/bilibili_workflow.py comments view \
  --url "https://www.bilibili.com/video/BV1xx411c7mD" \
  --count 20

python3 scripts/bilibili_workflow.py dynamic view --count 15

python3 scripts/bilibili_workflow.py feed view \
  --uid 123456 \
  --type all \
  --count 20

python3 scripts/bilibili_workflow.py history view --count 20

python3 scripts/bilibili_workflow.py me view

python3 scripts/bilibili_workflow.py following view --count 50

python3 scripts/bilibili_workflow.py user-videos view \
  --uid 123456 \
  --order pubdate \
  --count 20

python3 scripts/bilibili_workflow.py subtitle view \
  --url "BV1xx411c7mD" \
  --lang zh-CN

python3 scripts/bilibili_workflow.py summary view \
  --url "BV1xx411c7mD"
```
...
```bash
python3 -m py_compile scripts/bilibili_workflow.py
python3 scripts/bilibili_workflow.py --help
python3 scripts/bilibili_workflow.py hot view --count 3
python3 scripts/bilibili_workflow.py search view --query "OpenAI" --type video --count 3
python3 scripts/bilibili_workflow.py video view --url "BV1xx411c7mD"
```
