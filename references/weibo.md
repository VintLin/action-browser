...
```bash
python3 scripts/weibo_workflow.py --help
```
...
```bash
python3 scripts/weibo_workflow.py hot view \
  --count 30
```
...
```bash
python3 scripts/weibo_workflow.py feed view \
  --type for-you \
  --count 30

python3 scripts/weibo_workflow.py feed download \
  --type following \
  --count 30
```
...
```bash
python3 scripts/weibo_workflow.py post view \
  --url "https://weibo.com/<uid>/<bid>"

python3 scripts/weibo_workflow.py post download \
  --id "<idstr-or-mblogid>"
```
...
```bash
python3 scripts/weibo_workflow.py profile view \
  --profile-url "https://weibo.com/u/<uid>" \
  --count 30

python3 scripts/weibo_workflow.py profile download \
  --profile-url "https://weibo.com/u/<uid>" \
  --count 30
```
...
```bash
python3 scripts/weibo_workflow.py user view \
  --id "2619244577"
...
```bash
python3 scripts/weibo_workflow.py me view
```
...
```bash
python3 scripts/weibo_workflow.py user-posts view \
  --id "2619244577" \
  --count 30

python3 scripts/weibo_workflow.py user-posts download \
  --profile-url "https://weibo.com/u/2619244577" \
  --start 2026-05-01 \
  --end 2026-05-19 \
  --include-retweets \
...
```bash
python3 scripts/weibo_workflow.py search view \
  --keyword "关键词" \
  --count 30

python3 scripts/weibo_workflow.py search download \
  --keyword "关键词" \
  --count 30
```
...
```bash
python3 scripts/weibo_workflow.py home view --count 30
python3 scripts/weibo_workflow.py home download --count 30
```
...
```bash
python3 scripts/weibo_workflow.py comments view \
  --id "5300256976933486" \
  --count 20
```
...
```bash
python3 scripts/weibo_workflow.py favorites view \
  --count 20

python3 scripts/weibo_workflow.py favorites download \
  --count 20
```
