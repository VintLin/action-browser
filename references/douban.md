...
```bash
python3 scripts/douban_workflow.py search view \
  --type movie \
  --keyword "流浪地球" \
  --count 10

python3 scripts/douban_workflow.py top250 view --count 25

python3 scripts/douban_workflow.py movie-hot view --count 20

python3 scripts/douban_workflow.py book-hot view --count 20

python3 scripts/douban_workflow.py subject view \
  --id 30382501 \
  --type movie
...
python3 scripts/douban_workflow.py photos view \
  --id 30382501 \
  --type Rb \
  --count 20

python3 scripts/douban_workflow.py photos download \
  --id 30382501 \
  --type Rb \
  --count 5

python3 scripts/douban_workflow.py download \
  --id 30382501 \
  --type Rb \
  --count 5

python3 scripts/douban_workflow.py marks view \
  --status collect \
  --count 20

python3 scripts/douban_workflow.py reviews view \
  --count 20
```
...
```bash
python3 -m py_compile scripts/douban_workflow.py
python3 scripts/douban_workflow.py --help
python3 scripts/douban_workflow.py search view --type movie --keyword "流浪地球" --count 3
python3 scripts/douban_workflow.py subject view --id 30382501 --type movie
python3 scripts/douban_workflow.py photos download --id 30382501 --type Rb --count 2
```
