...
```bash
python3 scripts/adapters/youtube_workflow.py transcript view \
  --url "https://www.youtube.com/watch?v=VIDEO_ID" \
  --lang en

python3 scripts/adapters/youtube_workflow.py transcript download \
  --url "https://www.youtube.com/watch?v=VIDEO_ID" \
  --lang en \
  --mode grouped
```
...
```bash
python3 scripts/adapters/youtube_workflow.py search view \
  --query "OpenAI" \
  --type video \
  --count 5

python3 scripts/adapters/youtube_workflow.py video view \
  --url "https://www.youtube.com/watch?v=VIDEO_ID"

python3 scripts/adapters/youtube_workflow.py comments view \
  --url "https://www.youtube.com/watch?v=VIDEO_ID" \
  --count 20

python3 scripts/adapters/youtube_workflow.py channel view \
  --id "@OpenAI" \
  --count 10
...
python3 scripts/adapters/youtube_workflow.py feed view --count 20

python3 scripts/adapters/youtube_workflow.py history view --count 20

python3 scripts/adapters/youtube_workflow.py watch-later view --count 20

python3 scripts/adapters/youtube_workflow.py subscriptions view --count 20
```
...
```bash
python3 -m py_compile scripts/adapters/youtube_workflow.py
python3 scripts/adapters/youtube_workflow.py --help
python3 scripts/adapters/youtube_workflow.py search view --query "OpenAI" --type video --count 3
python3 scripts/adapters/youtube_workflow.py video view --url "https://www.youtube.com/watch?v=dQw4w9WgXcQ"
python3 scripts/adapters/youtube_workflow.py transcript download --url "https://www.youtube.com/watch?v=dQw4w9WgXcQ" --mode grouped
```
