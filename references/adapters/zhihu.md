...
```bash
python3 scripts/adapters/zhihu_workflow.py hot view --count 10

python3 scripts/adapters/zhihu_workflow.py recommend view --count 10

python3 scripts/adapters/zhihu_workflow.py search view \
  --query "agent" \
  --type all \
  --count 10
...
python3 scripts/adapters/zhihu_workflow.py answer-detail view \
  --id "https://www.zhihu.com/question/123456789/answer/987654321"

python3 scripts/adapters/zhihu_workflow.py collections view --count 20

python3 scripts/adapters/zhihu_workflow.py collection view \
  --id 83283292 \
  --count 20

python3 scripts/adapters/zhihu_workflow.py download \
...
```bash
python3 -m py_compile scripts/adapters/zhihu_workflow.py
python3 scripts/adapters/zhihu_workflow.py --help
python3 scripts/adapters/zhihu_workflow.py hot view --count 3
python3 scripts/adapters/zhihu_workflow.py search view --query "agent" --type all --count 3
python3 scripts/adapters/zhihu_workflow.py collections view --count 1
```
