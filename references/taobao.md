...
```bash
python3 scripts/taobao_workflow.py search view \
  --query "机械键盘" \
  --sort default \
  --count 10

python3 scripts/taobao_workflow.py detail view \
  --id 827563850178

python3 scripts/taobao_workflow.py reviews view \
  --id 827563850178 \
  --count 10
...
```bash
python3 scripts/taobao_workflow.py cart view --count 5
```
