...
```bash
python3 scripts/douyin_workflow.py profile view

python3 scripts/douyin_workflow.py videos view \
  --status all \
  --page 1 \
  --count 20

python3 scripts/douyin_workflow.py drafts view --count 20

python3 scripts/douyin_workflow.py collections view --count 20

python3 scripts/douyin_workflow.py activities view

python3 scripts/douyin_workflow.py hashtag view \
  --action search \
  --keyword "AI" \
  --count 10
...
python3 scripts/douyin_workflow.py location view \
  --query "北京" \
  --count 10

python3 scripts/douyin_workflow.py stats view \
  --aweme-id 1234567890123456789

python3 scripts/douyin_workflow.py user-videos view \
...
```bash
python3 -m py_compile scripts/douyin_workflow.py
python3 scripts/douyin_workflow.py --help
python3 scripts/douyin_workflow.py profile view --count 1
python3 scripts/douyin_workflow.py videos view --count 3
python3 scripts/douyin_workflow.py hashtag view --action hot --count 3
```
